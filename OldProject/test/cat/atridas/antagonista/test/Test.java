...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    core.init(800, 600, Test.class.getName(), new LWJGLManagerFactory(),
        new BulletFactory(), true, null);
    ...
    /*
     * HashedString hs6 = new HashedString("Material 2"); MaterialManager mm =
     * Core.getCore().getMaterialManager(); Material m = mm.getResource(hs6);
     * 
    ...
    pui.zTest = true;
    ((PhysicsWorldBullet) core.getPhysicsWorld()).createStaticRigidBody(
        habitacio.getPhysicsMesh(), new Vector3f(), pui, transform);
    ...
    sceneData.setCamera(new Point3f(20, -15, 10), new Point3f(0, 0, 0),
        new Vector3f(0, 0, 1));
    sceneData.setAmbientLight(new Color3f(0.3f, 0.3f, 0.3f));
    sceneData.setDirectionalLight(new Vector3f(0, 1, 1), new Color3f(0.3f,
        0.3f, 0.3f));

    RenderableObject ro1 = core.getRenderableObjectManager()
        .addRenderableObject(hs7, hs7);
    RenderableObject ro2 = core.getRenderableObjectManager()
        .addRenderableObject(hs8, hs7);
    RenderableObject ro3 = core.getRenderableObjectManager()
        .addRenderableObject(hs9, hs7);
    RenderableObject ro4 = core.getRenderableObjectManager()
        .addRenderableObject(hs10, hs7);
    ...
    // Font font = core.getFontManager().getResource(new
    // HashedString("font14"));

    DebugRender dr = core.getDebugRender();

    dr.addLine(new Point3f(0, 0, 0), new Point3f(25, 25, 25), new Color3f(1, 1,
        1), 30);
    ...
    while (!im.isCloseRequested() && !im.isActionActive(Utils.CLOSE)) {
      ...
      /*
       * dr.addLine(new Point3f(0,0,0), new Point3f(0,0,25), new
       * Color3f(0,0,1)); dr.addLine(new Point3f(0,0,0), new Point3f(0,25,0),
       * new Color3f(0,1,0)); dr.addLine(new Point3f(0,0,0), new
       * Point3f(25,0,0), new Color3f(1,0,0));
       * 
       ...
       * 
       * dr.addCircle(new Point3f(0,5,7), new Vector3f(0,0,1), 1, new
       * Color3f(0,1,0)); dr.addCircle(new Point3f(5,5,7), new Vector3f(0,1,0),
       * 2, new Color3f(0,0,1)); dr.addCircle(new Point3f(-5,-5,7), new
       * Vector3f(1,0,0), 1, new Color3f(1,0,0), false);
       * 
       * 
       * 
       * dr.addTriangle(new Point3f(-10,0,0), new Point3f(0,-10,0), new
       * Point3f(0,0,10), new Color3f(1,1,1)); dr.addTriangle(new
       * Point3f(20,0,0), new Point3f(0,20,0), new Point3f(0,0,20), new
       * Color3f(.7f,.7f,.7f)); dr.addTriangle(new Point3f(10,0,0), new
       * Point3f(0,10,0), new Point3f(0,0,10), new Color3f(.3f,.3f,.3f),false);
       * 
       * 
       * 
       * 
       * 
       * Matrix4f matN = new Matrix4f(); matN.setIdentity();
       * matN.setTranslation(new Vector3f(3,3,5)); dr.addAxes(matN, 3);
       * 
       * matN.setTranslation(new Vector3f(3,-3,5)); matN.setRotation(new
       * AxisAngle4f(0,0,1, (float)Math.PI / 6)); dr.addAxes(matN, 3);
       * 
       * 
       * dr.addAABB(new Point3f(-5,-5,-5), new Point3f(5,5,5), new
       * Color3f(1,1,1)); dr.addAABB(new Point3f(-2,-2,0), new Point3f(2,2,4),
       * new Color3f(.5f,.5f,.5f), false);
       * 
       * 
       * //Matrix4f matN = new Matrix4f(); matN.setIdentity();
       * matN.setTranslation(new Vector3f(3,3,5)); dr.addOBB(matN, new
       * Vector3f(3,3,3), new Color3f(1,1,1));
       * 
       * matN.setTranslation(new Vector3f(3,-3,5)); matN.setRotation(new
       * AxisAngle4f(0,0,1, (float)Math.PI / 6)); dr.addOBB(matN, new
       * Vector3f(2,3,3), new Color3f(1,1,1));
       */

      /*
       * dr.addCross(new Point3f(0,0,2), new Color3f(0,0,1), 1);
       * dr.addString(new Point3f(0,0,2), font, "Hola mundu", 1, new
       * Color3f(1,0,0));
       * 
       * dr.addCross(new Point3f(0,0,5), new Color3f(0,0,1), 1);
       * dr.addString(new Point3f(0,0,5), font, "Hola mundu", 1,
       * TextAlignment.MID_LEFT, new Color3f(1,0,0));
       * 
       * dr.addCross(new Point3f(0,0,8), new Color3f(0,0,1), 1);
       * dr.addString(new Point3f(0,0,8), font, "Hola mundu", 1,
       * TextAlignment.BOTTOM_LEFT, new Color3f(1,0,0));
       * 
       * dr.addCross(new Point3f(0,0,11), new Color3f(0,0,1), 1);
       * dr.addString(new Point3f(0,0,11), font, "Hola mundu", 1,
       * TextAlignment.BOTTOM_CENTER, new Color3f(1,0,0));
       * 
       * dr.addCross(new Point3f(0,0,14), new Color3f(0,0,1), 1);
       * dr.addString(new Point3f(0,0,14), font, "Hola mundu", 1,
       * TextAlignment.MID_CENTER, new Color3f(1,0,0));
       * 
       * 
       * dr.addString2D(new Point2f(.0f,.0f), font, "FPS: " + dt.fps, .05f, new
       * Color3f(0,0,0)); dr.addString2D(new Point2f(-.0f,-.0f), font, "FPS: " +
       * dt.fps, .05f, TextAlignment.BOTTOM_RIGHT, new Color3f(0,0,0));
       * 
       * 
       * dr.addString2D(new Point2f(.0f,.05f), font, "Mouse: " + im.getMouseX()
       * + ", " + im.getMouseY(), .03f, new Color3f(0,0,0));
       */
