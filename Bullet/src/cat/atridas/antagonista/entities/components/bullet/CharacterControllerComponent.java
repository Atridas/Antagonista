...
public class CharacterControllerComponent extends BaseComponent<CharacterControllerComponent> {
  ...
  public void init(Point3f _desiredPosition, 
      float _characterWidth, float _characterHeight, float _stepHeight,
      float _maxSpeed) {
  ...
  public String toString() {
    return "CharacterControllerComponent: [" + characterWidth + ", " + characterHeight + 
        ", " + stepHeight + ", " + maxSpeed + "] - " + desiredPosition;
  }

  //////////////////////////////////////////////////////////////////////////////////////////
  
  public final static class Global extends CharacterControllerComponent implements GlobalComponent<CharacterControllerComponent> {
  ...
  public final class Local extends CharacterControllerComponent implements LocalComponent<CharacterControllerComponent> {
  ...
  private final static HashedString componentType = new HashedString("CharacterControllerComponent");
