...
public final class PhysicsWorldBullet implements PhysicsWorld {
  ...
  public StaticRigidBody createStaticRigidBody(PhysicShape _physicShape, Vector3f fromGameToBulletOffset, PhysicsUserInfo _userInfo, Transformation _bodyTransform) {
	  return createStaticRigidBody((PhysicShapeBullet) _physicShape, fromGameToBulletOffset, _userInfo, _bodyTransform);
  }
  
  public StaticRigidBody createStaticRigidBody(PhysicShapeBullet _physicShape, Vector3f fromGameToBulletOffset, PhysicsUserInfo _userInfo, Transformation _bodyTransform) {
