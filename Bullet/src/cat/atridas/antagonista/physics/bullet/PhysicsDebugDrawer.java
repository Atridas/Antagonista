...
public class PhysicsDebugDrawer extends IDebugDraw {
   ...
   * @since 0.2
   */
  public Font font = Core.getCore().getFontManager()
      .getResource(new HashedString("font14"));
  ...
  public void draw3dText(Vector3f position, String text) {
    assert font != null;
    dr.addString(new Point3f(position), font, text, text3DHeight,
        defaultDebugColor, zTest);
  }
  ...
  public void reportErrorWarning(String text) {
    dr.addString2D(new Point2f(0, 0), font, text, text2DHeight,
        defaultDebugColor);
  }
