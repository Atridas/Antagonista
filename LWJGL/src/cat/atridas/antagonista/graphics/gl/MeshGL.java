...
public abstract class MeshGL extends Mesh {
  private static Logger LOGGER = Logger.getLogger(MeshGL.class
      .getCanonicalName());
  ...
  /**
   * Creates a new vertex array object for this mesh, if the OpenGL
  ...
  public final void render(int _submesh, RenderManager rm) {
    ...
    glDrawElements(GL_TRIANGLES, numFaces[_submesh] * 3, GL_UNSIGNED_SHORT,
        stride);
