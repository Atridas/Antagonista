...
public final class RenderableObjectManagerGL3 extends RenderableObjectManager {
  ...
  public boolean init() {
    ...
    glBufferData(GL_UNIFORM_BUFFER, InstanceBufferUtils.BUFFER_SIZE
        * Utils.FLOAT_SIZE, GL_DYNAMIC_DRAW);
    glBindBuffer(GL_UNIFORM_BUFFER, 0);

    glBindBuffer(GL_UNIFORM_BUFFER, boneBufferID);
    glBufferData(GL_UNIFORM_BUFFER, TechniquePass.ARMATURE_UNIFORMS_BLOCK_SIZE,
        GL_DYNAMIC_DRAW);
    glBindBuffer(GL_UNIFORM_BUFFER, 0);
  ...
  protected void setInstanceUniforms(InstanceData instanceData) {
    ...
    glBindBufferRange(GL_UNIFORM_BUFFER,
        TechniquePass.BASIC_INSTANCE_UNIFORMS_BINDING, bufferID, 0,
    ...
    glBindBufferRange(GL_UNIFORM_BUFFER,
        TechniquePass.SPECIAL_COLORS_UNIFORMS_BINDING, bufferID,
        InstanceBufferUtils.COLOR_OFFSET, 4 * 4 * Utils.FLOAT_SIZE);
    ...
    if (instanceData.bonePalete != null) {
      ...
      boneBuffer.position(TechniquePass.ARMATURE_UNIFORMS_BLOCK_SIZE
          / (Utils.FLOAT_SIZE * 2));
      ...
      boneBuffer.limit(TechniquePass.ARMATURE_UNIFORMS_BLOCK_SIZE
          / Utils.FLOAT_SIZE);
      ...
      glBindBufferRange(GL_UNIFORM_BUFFER,
          TechniquePass.ARMATURE_UNIFORMS_BINDING, boneBufferID, 0,
