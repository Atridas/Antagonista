...
public final class MeshGL3 extends MeshGL {
  ...
  protected void createVertexArrayObject() {
    ...
    if (animated) {
      ...
      glVertexAttribIPointer(TechniquePass.BLEND_INDEX_ATTRIBUTE, 4, GL_SHORT,
          stride, 14 * Utils.FLOAT_SIZE);
  ...
  public void render(int _submesh, int _instances, RenderManager rm) {
    ...
    glDrawElementsInstanced(GL_TRIANGLES, numFaces[_submesh], GL_SHORT, stride,
        _instances);
