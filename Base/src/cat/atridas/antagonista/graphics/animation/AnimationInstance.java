...
public interface AnimationInstance {
  ...
  /**
   * Gets the state of a bone. This function blends the current state with the
   * state of this animation. If the weight is 0, the bone is left unmodified,
   * if it is 1, it gets all the power of this animation.
   * 
   * @param bone_
   *          to retrieve (output parameter).
   * @param weight
