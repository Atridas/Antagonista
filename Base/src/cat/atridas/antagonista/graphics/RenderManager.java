...
public abstract class RenderManager {
   ...
   */
	...
	/**
	 * Computes the aspect ratio. This method returns how many pixels are in horizontal for each
	 * vertical pixel.
	 *  
   ...
   * @since 0.1
	 ...
	 * 
	 * @param enable if the test should be activated or deactivated.
	 * @since 0.1
	 */
  public abstract void setDepthTest(boolean enable);
  /**
   * Activates or deactivates writing to the Depth Buffer after passing the depth test.
   * 
   * @param enable if z-write should be active or not.
   * @since 0.1
   */
   ...
   * 
   * @param function What comparison operator should be used in the depth test.
   * @since 0.1
   */
   ...
   * 
   * @param enable if alpha blending should be active.
   * @since 0.1
   */
   ...
   * 
   * @param operation used in alpha blending.
   * @since 0.1
   */
   ...
   * 
   * @param enable if alpha blending should be active.
   * @param renderTarget number of the render target to change alpha blending.
   * @throws IllegalStateException if this context does not implement this functionality.
   * @since 0.1
   */
  ...
  /**
   * Gets the maximum number of instances a basic mesh can have. This method computes how many
   * instances can be successfully rendered at once with the current memory constrains.
   * 
  ...
  /**
   * Gets the maximum number of instances an animated mesh can have. This method computes how many
   * instances can be successfully rendered at once with the current memory constrains.
   * 
   * @return the maximum number of instances.
   * @since 0.1
  ...
  /**
   * Gets the maximum number of instances a colored material can have. This method computes how many
   * instances can be successfully rendered at once with the current memory constrains.
   * 
   * @return the maximum number of instances.
   * @since 0.1
  ...
  public static enum Profile {
     ...
     * @since 0.1
     * @throws IllegalArgumentException if the string does not have a valid value.
     */
     ...
     * 
     * @param other capabilities to check.
    ...
    /**
     * If this profile does not support another profile capabilities, throws an unchecked 
     * exception.
     * 
     * @param other capabilities to check.
     * @param functionality used in the log severe message.
     * @since 0.1
     * @throws RuntimeException if the functionality is not supported.
     */
    public void supportOrException(Profile other, String functionality) {
      if(!supports(other)) {
        ...
        throw new RuntimeException("Functionality " + functionality + " needs a context of " + other.toString() + " or greater.");
      }
    }
  ...
  public static enum DepthFunction {
    /**
     * Depth test passes if incoming fragment's depth is less that the previous fragment depth.
     * @since 0.1
     */
    LESS,
    /**
     * Depth test passes if incoming fragment's depth is greater that the previous fragment depth.
     * @since 0.1
     */
    GREATER,
    /**
     * Depth test passes if incoming fragment's depth is equal that the previous fragment depth.
     * @since 0.1
     */
    EQUAL,
    /**
     * Depth test passes if incoming fragment's depth is not equal that the previous fragment depth.
     * @since 0.1
     */
    NOTEQUAL,
    /**
     * Depth test passes if incoming fragment's depth is less or equal that the previous
     *  fragment depth.
     * @since 0.1
     */
    LEQUAL,
    /**
     * Depth test passes if incoming fragment's depth is greater or equal that the previous 
     * fragment depth.
     * @since 0.1
     */
    GEQUAL,
  ...
  public static final class BlendOperation {
    /**
     * Operator used to multiply the new fragment value in the blending function.
     * @since 0.1
     */
    public BlendOperator src_operator;
    /**
     * Operator used to multiply the previous fragment value in the blending function.
     * @since 0.1
     */
