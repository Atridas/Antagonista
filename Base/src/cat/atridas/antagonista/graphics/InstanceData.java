...
public class InstanceData {
  /**
   * Model View Projection transformation matrix. This matrix transforms a
   * vertex from local coordinates to homogeneous coordinates.
   * 
   * @since 0.1
   */
  ...
  /**
   * Inverse Model View transformation matrix. This matrix transforms a vertex
   * from view coordinates (where the camera is the origin) to local
   * coordinates.
   * 
   * @since 0.1
   */
