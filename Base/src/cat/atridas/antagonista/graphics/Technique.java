...
public final class Technique {
  ...
  // Logger.getLogger(TechniquePass.class.getCanonicalName());
   ...
   *           if there was an error building the technique.
   * @since 0.1
   */
  public Technique(Element techniqueXML) throws AntagonistException {
    ...
    // Profile p =
    // Profile.getFromString(techniqueXML.getAttribute("min_version"));
  ...
  public static abstract class TechniquePassFactory {
    ...
    protected abstract TechniquePass createTechniquePass(
        Element techniquePassXML) throws AntagonistException;
