...
public class CameraComponent extends BaseComponent<CameraComponent> {
  ...
  public final static class Global extends CameraComponent implements
      GlobalComponent<CameraComponent> {
  ...
  public final class Local extends CameraComponent implements
      LocalComponent<CameraComponent> {
