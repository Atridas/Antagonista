...
/**
 * This class represents a string in a hashed form. Used to speed maps with a
 * string key.
 * 
...
public final class HashedString implements Comparable<HashedString> {
  ...
  /**
   * Creates a new Hashed String. This constructor is SLOW, it is better to
   * declare any HashedString you must use as a static field than to call this
   * constructor every frame.
   * 
   * @since 0.1
   * @param str
   *          string to transform.
   * @throws RuntimeException
   *           if the string created has an alias (other string with the same
   *           hash value).
   */
  public HashedString(final String str) {
    ...
    if (prev != null && !prev.equals(str)) {
      throw new RuntimeException(
          "There are 2 strings with the same hash value: \"" + prev
              + "\" and \"" + str);
    } else {
  ...
  public boolean equals(Object o) {
    if (o == null)
      return false;
    if (o.getClass() != HashedString.class)
      return false;
